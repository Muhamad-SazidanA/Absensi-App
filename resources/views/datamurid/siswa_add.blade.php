...
@section('content-dinamis')
    <div class="container mt-5">
        ...
        <div class="card shadow-lg mx-auto">
            <div class="card-body">
                <form action="{{ route('datamurid.siswa_add.store') }}" method="POST">
                    @csrf
                    <div class="mb-3">
                        <label for="siswa" class="form-label">Nama Siswa</label>
                        <input type="text" name="siswa" id="siswa" class="form-control"
                            placeholder="Masukkan Nama Siswa" value="{{ old('siswa') }}" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="rayon" id="rayon" class="form-control"
                            placeholder="Masukkan Rayon" value="{{ old('rayon') }}" required>
                    </div>
                    <div class="mb-3">
                        <label for="rombel" class="form-label">Rombel</label>
                        <input type="text" name="rombel" id="rombel" class="form-control"
                            placeholder="Masukkan Rombel" value="{{ old('rombel') }}" required>
                    </div>
